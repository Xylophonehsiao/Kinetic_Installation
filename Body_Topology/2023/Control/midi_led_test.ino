...
NoteValueLED led1 = {
  4,             // Pin of built-in LED
  {note(A, 3), CHANNEL_1}, // Note C4 on MIDI channel 1
};

NoteValueLED led2 = {
  5,             // Pin of built-in LED
  {note(B, 3), CHANNEL_1}, // Note C4 on MIDI channel 1
};

NoteValueLED led3 = {
  6,             // Pin of built-in LED
  {note(C, 3), CHANNEL_1}, // Note C4 on MIDI channel 1
};

NoteValueLED led4 = {
  7,             // Pin of built-in LED
  {note(D, 3), CHANNEL_1}, // Note C4 on MIDI channel 1
};
